.PHONY: help install install-rtb install-all install-kali test test-rtb test-server test-vision test-planning smoke smoke-ui uat sim lint clean server web web-build web-typecheck
