...
export function RobotDetailScreen({ robot }: Props) {
  ...
  const layout: SplitNode = {
    ...
    children: [
      { type: "split", direction: "h", key: "top", size: 55, children: [
        { type: "leaf", key: "side", size: 42, content: sidePanel },
        { type: "leaf", key: "tcp", size: 29, content: tcpPanel },
        { type: "leaf", key: "joints", size: 29, content: jointsPanel },
      ]},
      { type: "split", direction: "h", key: "bot", size: 45, children: [
        { type: "leaf", key: "io", size: 42, content: ioPanel },
        { type: "leaf", key: "ft", size: 29, content: ftPanel },
        { type: "leaf", key: "status", size: 29, content: statusPanel },
      ]},
    ],
  };

  return <SplitScreen id="robot" className="screen robot" node={layout} />;
}
