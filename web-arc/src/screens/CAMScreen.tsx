...
export function CAMScreen({ robot }: CAMScreenProps) {
  ...
  const camPanel = (
    <Panel title="CAM · CLICK SURFACE TO DEFINE PATH" pad={false}
      right={
  ...
  const layout: SplitNode = {
    ...
    children: [
      { type: "split", direction: "v", key: "L", size: 65, children: [
        { type: "leaf", key: "cam", size: 70, content: camPanel },
        { type: "leaf", key: "traj", size: 30, content: trajPanel },
      ]},
      { type: "split", direction: "v", key: "R", size: 35, children: [
        { type: "leaf", key: "params", size: 65, content: paramsPanel },
        { type: "leaf", key: "picks", size: 35, content: picksPanel },
      ]},
    ],
  };
  ...
  return (
    <>
      <SplitScreen id="cam" className="screen cam" node={layout} />
      {void robot}
    </>
  );
}
